  ...
  return (
    <div className='min-h-screen h-full flex flex-col justify-center items-center'>
        <div className='flex flex-wrap gap-6 pt-6'>
          <Image src='/me.png' alt='pfp' width={140} height={140}  className='hidden md:flex object-contain rounded-full' />
          <div className='max-w-4xl'>
            <WordPullUp
              className="font-bold text-black dark:text-white md:text-6xl text-4xl md:leading-[5rem]"
              words="Hi, I&apos;m Subhamay Dey"
            />
            <WordPullUp
              className="mt-4 text-gray-600 dark:text-gray-400 text-[16px] md:text-[18px] max-w-3xl px-4"
              words="Full stack Web Developer with a passion for building beautiful and functional websites and applications."
            />
          </div>
